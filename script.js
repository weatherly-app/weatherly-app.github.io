const apiKey = '11e5e890f3eb43d2834153732240111';
        ...
        function updateHourlyForecastChart(data) {
            ...
            const snow = hourlyData.map(hour => hour.snow_cm || 0); // Added snow data
...
function updateForecastChart(forecastData) {
    ...
    const snowfall = forecastData.map(day => day.day.totalsnow_cm); // Add snowfall data
        ...
        options: {
            ...
            scales: {
                'y-axis-rainfall': {
                    ...
                    stacked: false // This will stack the rain and snow bars
                },
                'y-axis-temperature': {
                    type: 'linear',
                    position: 'right',
